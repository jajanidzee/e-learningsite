  ...
  return (
    <div className="bg-[url('/Partner.png')] w-[1920px] h-[326px] py-[80px] pl-[303px] pr-[298px]">
      <div className="relative">
        ...
        />
        <button className="cursor-pointer w-[183.16px] rounded-[12px] py-[16px] px-[41.32px] text-[24px] font-bold font-[Poppins] text-[#fff] bg-[#49BBBD] absolute right-[2px] top-[3px]">
          Search
        </button>
